...
public class AdicionarMusicaProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(p1, m2, List.of(m1, m3, m4, m2)),
        Arguments.of(p2, m6, List.of(m2, m5, m6)),
        Arguments.of(p3, m1, List.of(m7, m8, m1)),
        Arguments.of(p4, m4, List.of(m4)),
        Arguments.of(p5, m3, List.of(m5, m3))
    );
  }
}
