...
public class AvaliarProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(p1, 8, List.of(8)),
        Arguments.of(p2, 7, List.of(9, 8, 10, 7)),
        Arguments.of(p3, 9, List.of(7, 6, 9)),
        Arguments.of(p4, 6, List.of(10, 9, 8, 7, 6, 6)),
        Arguments.of(p5, 10, List.of(5, 10))
    );
  }
}
