...
public class BuscarMusicaPorGeneroProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        ...
        return Stream.of(
                Arguments.of(s1, "ROCK", List.of(m1)),
                Arguments.of(s2, "POP", List.of()),
                Arguments.of(s3, "SERTANEJO", List.of()),
                Arguments.of(s4, "FUNK", List.of(m6)),
                Arguments.of(s4, "SERTANEJO", List.of(m7, m8)),
                Arguments.of(s5, "ELETRONICA", List.of(m5))
        );
    }
}
