...
public class BuscarCelularesPorMarcaProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    Object c4 = CelularFactory.build("Celular D", 1500.0, 0.7, 18, "Marca X");
    Object c5 = CelularFactory.build("Celular E", 500.0, 0.3, 0, "Marca Y");
    ...
    return Stream.of(
        Arguments.of(1, List.of(c1, c2, c3, c4, c5), "Marca X", List.of(c1, c4)),
        Arguments.of(2, List.of(c1, c2, c3, c4, c5), "Marca Y", List.of(c2, c5)),
        Arguments.of(3, List.of(c1, c2, c3, c4, c5), "Marca Z", List.of(c3)),
        Arguments.of(4, List.of(c1, c2, c3, c4, c5), "Marca W", List.of()),
        Arguments.of(5, List.of(p1, p2, r1, r2), "Marca X", List.of()),
        Arguments.of(6, List.of(), "Marca X", List.of())
    );
  }
}
