...
public class BuscarProdutoPorNomeProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(1, List.of(p1, p2, p3), "Produto A", p1),
        Arguments.of(2, List.of(p1, p2, p3), "Produto B", p2),
        Arguments.of(3, List.of(p1, p2, p3), "Produto C", p3),
        Arguments.of(4, List.of(c1, c2, c3), "Celular A", c1),
        Arguments.of(5, List.of(c1, c2, c3), "Celular B", c2),
        Arguments.of(6, List.of(c1, c2, c3), "Celular C", c3),
        Arguments.of(7, List.of(r1, r2, r3), "Roupa A", r1),
        Arguments.of(8, List.of(r1, r2, r3), "Roupa B", r2),
        Arguments.of(9, List.of(r1, r2, r3), "Roupa C", r3),
        Arguments.of(10, List.of(p4, p5, r1, c1), "Produto D", p4)
    );
  }
}
