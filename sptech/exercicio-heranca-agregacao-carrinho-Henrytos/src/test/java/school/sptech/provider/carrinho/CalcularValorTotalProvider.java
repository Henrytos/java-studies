...
public class CalcularValorTotalProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(1, List.of(p1, p2, p3), 245.0),
        Arguments.of(2, List.of(c1, c2, c3), 5100.0),
        Arguments.of(3, List.of(r1, r2, r3), 605.0),
        Arguments.of(4, List.of(p1, c1, r1), 1850.0),
        Arguments.of(5, List.of(p4, p5), 500.0),
        Arguments.of(6, List.of(), 0.0)
    );
  }
}
