...
public class BuscarCelularesForaDaGarantiaProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(1, List.of(c1, c2, c3, c4, c5), 13, List.of(c1, c2, c5)),
        Arguments.of(2, List.of(p1, p2, c3, c4, c5), 25, List.of(c3, c4, c5)),
        Arguments.of(3, List.of(c1, c2, c3, c4, c5), 6, List.of(c5)),
        Arguments.of(4, List.of(c1, c2, c3, c4, c5), 0, List.of()),
        Arguments.of(5, List.of(p1, p2, r1, r2), 12, List.of()),
        Arguments.of(6, List.of(), 12, List.of())
    );
  }
}
