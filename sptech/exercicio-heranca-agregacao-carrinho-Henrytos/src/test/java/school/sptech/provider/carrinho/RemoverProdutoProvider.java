...
public class RemoverProdutoProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(1, List.of(p1, p2, p3), "Produto A", List.of(p2, p3)),
        Arguments.of(2, List.of(p1, p2, p3), "Produto B", List.of(p1, p3)),
        Arguments.of(3, List.of(p1, p2, p3), "Produto C", List.of(p1, p2)),
        Arguments.of(4, List.of(c1, c1, c2, c3), "Celular A", List.of(c2, c3)),
        Arguments.of(5, List.of(c1, c2, c3), "Celular B", List.of(c1, c3)),
        Arguments.of(6, List.of(c1, c2, c3), "Celular C", List.of(c1, c2)),
        Arguments.of(7, List.of(r1, r2, r3), "Roupa A", List.of(r2, r3)),
        Arguments.of(8, List.of(r1, r2, r3), "Roupa B", List.of(r1, r3)),
        Arguments.of(9, List.of(r1, r2, r3), "Roupa C", List.of(r1, r2)),
        Arguments.of(10, List.of(p4, p5, c4, r4), "Produto D", List.of(p5, c4, r4))
    );
  }
}
