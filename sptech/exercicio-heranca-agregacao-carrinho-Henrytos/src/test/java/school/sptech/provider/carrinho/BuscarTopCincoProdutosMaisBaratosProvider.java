...
public class BuscarTopCincoProdutosMaisBaratosProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
    ...
    return Stream.of(
        Arguments.of(1, List.of(p1, p2, p3, p4, p5, c1, c2, c3, c4, c5), List.of(p1, p2, p3, p4, p5)),
        Arguments.of(2, List.of(c1, c2, c3, c4, c5), List.of(c5, c2, c1, c3, c4)),
        Arguments.of(3, List.of(r1, r2, r3, r4, r5), List.of(r5, r3, r1, r2, r4)),
        Arguments.of(4, List.of(p1, c1, r1), List.of(p1, r1, c1)),
