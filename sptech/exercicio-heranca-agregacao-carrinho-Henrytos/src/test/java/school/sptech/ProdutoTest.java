...
import school.sptech.provider.produto.CalcularPrecoFinalProvider;
...
public class ProdutoTest {
  ...
  class AtributosTest {
    ...
    void test1() {
      ...
      assertAll(
          ...
          () -> assertDoesNotThrow(() -> clazz.getDeclaredField("preco"), "Deve possuir o atributo preco"),
          () -> assertDoesNotThrow(() -> clazz.getDeclaredField("peso"), "Deve possuir o atributo peso")
      );
    }
  }
  ...
  class MetodosTest {
    ...
    void test1() {
      ...
      assertAll(
          () -> assertDoesNotThrow(() -> clazz.getDeclaredMethod("calcularPrecoFinal"), "Deve possuir o método calcularPrecoFinal")
      );
    }
  }
  ...
  class MetodoCalcularPrecoFinalTest {
    ...
    @DisplayName("Teste 1")
    void test1(String nome, Double preco, Double peso, Double expected) throws ReflectiveOperationException {
      Class<Produto> clazz = Produto.class;
