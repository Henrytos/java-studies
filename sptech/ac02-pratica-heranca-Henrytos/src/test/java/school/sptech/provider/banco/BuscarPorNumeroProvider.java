...
public class BuscarPorNumeroProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        ...
        return Stream.of(
                Arguments.of(List.of(c1, c2, c3), "005", c2),
                Arguments.of(List.of(c1, c2, c3, c4, c5), "001", c3),
                Arguments.of(List.of(c6, c7, c8, c9, c10), "009", c9),
                Arguments.of(List.of(c1, c10, c2, c9, c4), "001", null),
                Arguments.of(List.of(), "001", null)
        );
    }
}
