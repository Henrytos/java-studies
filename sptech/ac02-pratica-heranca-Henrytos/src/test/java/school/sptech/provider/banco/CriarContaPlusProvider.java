...
public class CriarContaPlusProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        ...
        return Stream.of(
                ...
                Arguments.of(List.of(c5, c2, c3), "002", "Beatriz", List.of(c5, c2, c3, c4)),
                Arguments.of(List.of(c6), "007", null, List.of(c6)),
                Arguments.of(List.of(c7), null, "Renata", List.of(c7)),
                Arguments.of(List.of(c8), "", "", List.of(c8)),
