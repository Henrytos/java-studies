...
public class BuscarContasComPontosMaiorProvider implements ArgumentsProvider {

    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        Object c1 = ContaCorrentePlusFactory.build("007", "Mario", 0.0, 100);
        Object c2 = ContaCorrentePlusFactory.build("005", "Carlos", 0.0, 50);
        Object c3 = ContaCorrentePlusFactory.build("001", "Ana", 0.0, 20);
        ...
        return Stream.of(
                Arguments.of(List.of(c1, c2, c3), 30, List.of(c1, c2)),
                Arguments.of(List.of(c1, c2, c3, c4, c5), 40, List.of(c1, c2)),
                Arguments.of(List.of(c6, c7, c8, c9, c10), 0, List.of()),
                Arguments.of(List.of(c1, c10, c2, c9, c4), 90, List.of(c1)),
