...
public class WriteArticleUseCaseTest {
    ...
    @InjectMocks
    private WriteArticleUseCase writeArticleUseCase; // sut = system under test = sistema em teste, one two
    ...
    public WriteArticleUseCaseTest() {
    ...
    class SuccessTest {
        ...
        public void should_be_able_create_a_new_article() {
            ...
            ArticleEntity response = writeArticleUseCase.execute(user.getId(), dto);
    ...
    class FailureTest {
        ...
        public void should_not_be_able_create_a_new_article_if_author_not_found() {
            ...
            UserNotFoundException exception = assertThrows(UserNotFoundException.class, () -> {
                writeArticleUseCase.execute(user.getId(), dto);
            });
